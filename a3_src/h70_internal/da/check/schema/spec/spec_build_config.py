# -*- coding: utf-8 -*-
"""
Unit tests for the da.check.schema.build_config module.
...
class SpecifyGet:
    """
    Specify the da.check.schema.build_config.get() function.
    ...
    def it_returns_a_callable(self, idclass_tab):
        ...
        schema = da.check.schema.build_config.get(idclass_tab)
