# -*- coding: utf-8 -*-
"""
Package containing a data validation schema for the process register.
...
def get(idclass_tab):
    """
    Return the data validation schema for the process register.

    """
    common           = da.check.schema.common
    process_id       = idclass_tab['process']
